package android.support.v17.leanback.supportleanbackshowcase.chromecast;
...
import android.support.v17.leanback.supportleanbackshowcase.chromecast.notifications.NotificationManager;
import android.support.v17.leanback.supportleanbackshowcase.chromecast.notifications.PlaybackControllerBroadcastReceiver;
import android.support.v17.leanback.supportleanbackshowcase.chromecast.utils.MediaRouteButtonUtils;
import android.support.v17.leanback.supportleanbackshowcase.chromecast.utils.PlayServicesUtils;
 ...
 */
public class ChromecastActivity extends AppCompatActivity implements YouTubePlayersManager.LocalYouTubePlayerInitListener, ChromecastConnectionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notificationManager = new NotificationManager(this, ChromecastActivity.class);

...
import android.support.v17.leanback.supportleanbackshowcase.chromecast.ui.SimpleChromecastUIController;
            ...
            youtubePlayer.addListener(new AbstractYouTubePlayerListener() {
                public void onReady() {
                    if (!playingOnCastPlayer)
                        ...
                        youtubePlayer.loadVideo(PlaybackUtils.getVideoId(), chromecastPlayerStateTracker.getCurrentSecond());

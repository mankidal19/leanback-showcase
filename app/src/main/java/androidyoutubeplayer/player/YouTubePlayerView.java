package androidyoutubeplayer.player;
...
import androidyoutubeplayer.player.listeners.YouTubePlayerInitListener;
import androidyoutubeplayer.player.playerUtils.FullScreenHelper;
import androidyoutubeplayer.player.playerUtils.PlaybackResumer;
import androidyoutubeplayer.ui.DefaultPlayerUIController;
import androidyoutubeplayer.ui.PlayerUIController;
import androidyoutubeplayer.utils.Callable;
import androidyoutubeplayer.utils.NetworkReceiver;
...
public class YouTubePlayerView extends FrameLayout implements NetworkReceiver.NetworkListener, LifecycleObserver {
     ...
     * @param handleNetworkEvents if <b>true</b> a broadcast receiver will be registered.<br/>If <b>false</b> you should handle network events with your own broadcast receiver. See {@link com.pierfrancescosoffritti.androidyoutubeplayer.player.YouTubePlayerView#onNetworkAvailable()} and {@link com.pierfrancescosoffritti.androidyoutubeplayer.player.YouTubePlayerView#onNetworkUnavailable()}
     */
     ...
     * the default controller obtained through {@link com.pierfrancescosoffritti.androidyoutubeplayer.player.YouTubePlayerView#getPlayerUIController()} won't be available anymore.

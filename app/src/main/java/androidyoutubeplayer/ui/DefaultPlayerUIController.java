package androidyoutubeplayer.ui;
...
import androidyoutubeplayer.player.PlayerConstants;
import androidyoutubeplayer.player.YouTubePlayer;
import androidyoutubeplayer.player.YouTubePlayerView;
import androidyoutubeplayer.player.listeners.YouTubePlayerFullScreenListener;
import androidyoutubeplayer.player.listeners.YouTubePlayerListener;
import androidyoutubeplayer.ui.menu.YouTubePlayerMenu;
import androidyoutubeplayer.ui.menu.defaultMenu.DefaultYouTubePlayerMenu;
import androidyoutubeplayer.utils.Utils;
...
public class DefaultPlayerUIController implements PlayerUIController, YouTubePlayerListener, YouTubePlayerFullScreenListener, View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    public DefaultPlayerUIController(@NonNull YouTubePlayerView youTubePlayerView, @NonNull YouTubePlayer youTubePlayer) {
        ...
        View defaultPlayerUI = View.inflate(youTubePlayerView.getContext(), com.pierfrancescosoffritti.androidyoutubeplayer.R.layout.default_player_ui, youTubePlayerView);
    ...
    private void initViews(View controlsView) {
        panel = controlsView.findViewById(com.pierfrancescosoffritti.androidyoutubeplayer.R.id.panel);

        controlsRoot = controlsView.findViewById(com.pierfrancescosoffritti.androidyoutubeplayer.R.id.controls_root);
        extraViewsContainer = controlsView.findViewById(com.pierfrancescosoffritti.androidyoutubeplayer.R.id.extra_views_container);

        videoTitle = controlsView.findViewById(com.pierfrancescosoffritti.androidyoutubeplayer.R.id.video_title);
        videoCurrentTime = controlsView.findViewById(com.pierfrancescosoffritti.androidyoutubeplayer.R.id.video_current_time);
        videoDuration = controlsView.findViewById(com.pierfrancescosoffritti.androidyoutubeplayer.R.id.video_duration);
        liveVideoIndicator = controlsView.findViewById(com.pierfrancescosoffritti.androidyoutubeplayer.R.id.live_video_indicator);

        progressBar = controlsView.findViewById(com.pierfrancescosoffritti.androidyoutubeplayer.R.id.progress);
        menuButton = controlsView.findViewById(com.pierfrancescosoffritti.androidyoutubeplayer.R.id.menu_button);
        playPauseButton = controlsView.findViewById(com.pierfrancescosoffritti.androidyoutubeplayer.R.id.play_pause_button);
        youTubeButton = controlsView.findViewById(com.pierfrancescosoffritti.androidyoutubeplayer.R.id.youtube_button);
        fullScreenButton = controlsView.findViewById(com.pierfrancescosoffritti.androidyoutubeplayer.R.id.fullscreen_button);

        customActionLeft = controlsView.findViewById(com.pierfrancescosoffritti.androidyoutubeplayer.R.id.custom_action_left_button);
        customActionRight = controlsView.findViewById(com.pierfrancescosoffritti.androidyoutubeplayer.R.id.custom_action_right_button);

        seekBar = controlsView.findViewById(com.pierfrancescosoffritti.androidyoutubeplayer.R.id.seek_bar);
    ...
    private void updatePlayPauseButtonIcon(boolean playing) {
        int img = playing ? com.pierfrancescosoffritti.androidyoutubeplayer.R.drawable.ic_pause_36dp : com.pierfrancescosoffritti.androidyoutubeplayer.R.drawable.ic_play_36dp;
    ...
    public void onYouTubePlayerEnterFullScreen() {
        fullScreenButton.setImageResource(com.pierfrancescosoffritti.androidyoutubeplayer.R.drawable.ic_fullscreen_exit_24dp);
    }

    @Override
    public void onYouTubePlayerExitFullScreen() {
        fullScreenButton.setImageResource(com.pierfrancescosoffritti.androidyoutubeplayer.R.drawable.ic_fullscreen_24dp);
    }

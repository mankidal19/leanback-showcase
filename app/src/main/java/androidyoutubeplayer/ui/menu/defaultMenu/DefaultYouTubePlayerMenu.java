...
public class DefaultYouTubePlayerMenu implements YouTubePlayerMenu {
    ...
    public void show(View anchorView) {
        ...
        popupWindow.showAsDropDown(anchorView, 0, - context.getResources().getDimensionPixelSize(com.pierfrancescosoffritti.androidyoutubeplayer.R.dimen._8dp) * 4);
    ...
    private PopupWindow createPopupWindow() {
        ...
        View view = inflater.inflate(com.pierfrancescosoffritti.androidyoutubeplayer.R.layout.player_menu, null);

        RecyclerView recyclerView = view.findViewById(com.pierfrancescosoffritti.androidyoutubeplayer.R.id.recycler_view);
